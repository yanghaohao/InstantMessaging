...
class ContactListAdapter(private val context: Context,val contactListItems:MutableList<ContactListItem>) : RecyclerView.Adapter<ContactListAdapter.ContactListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContactListViewHolder = ContactListViewHolder(ContractListItemView(context))
    ...
    override fun onBindViewHolder(holder: ContactListViewHolder, position: Int) {
        ...
        contactListView.setOnClickListener{context.startActivity<ChatActivity>("userName" to userName)}
